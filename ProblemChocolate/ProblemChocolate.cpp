// ProblemChocolate.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	std::vector<big_integer> count(n / 2 + 1);
	count[0] = big_integer(1);
